...
- `01-frontmatter.md` — SKILL.md frontmatter: Agent Skills standard fields and skillbook metadata
- `02-navigation-and-toc.md` — Navigation instructions and table of contents format rules
- `03-license-and-quickstart.md` — License section requirements and optional quick start paths
- `04-readme.md` — README.md as the human-facing catalog entry

Read in order — frontmatter first, then TOC, then license. README.md is independent.
